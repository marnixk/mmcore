...
static const char kHelpTerm[] =
	...
	"no arguments TERM starts disconnected; use Alt+F and\n"
	...
	"background (boxed, MODE 14 960x540). File-menu\n"
	...
	"Alt+F opens a File menu in the EDIT menu-bar style.\n"
	"The status bar (F10/Alt-X, Echo, host) is shown only\n"
	"while that menu is open. Echo ON backspace only erases\n"
	"characters typed since the last newline.\n"
	"File menu: Exit, Echo ON/OFF, Boxed/Full,\n"
