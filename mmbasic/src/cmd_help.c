...
static const char kIndexCommands[] =
	...
	"  Needs onboard radio + C:/firmware/; QEMU has none. HELP OPTION for more.\n"
	"\n"
...
static const char kHelpOption[] =
	...
	"  WIFI [ssid$ [, password$]]\n"
	"    No args: scan and prompt (needs onboard radio).\n"
	"    With args: store credentials in .mmbasic.ini\n"
	"    and join with WPA2. Hardware images ship\n"
	"    C:/firmware/brcmfmac*. QEMU has no Wi-Fi radio.\n"
	"\n"
