...
static const char kHelpTerm[] =
	...
	"Incoming TCP is drained into a 512KB ring before a pane\n"
	"redraw so a busy BBS does not starve receive or drop a\n"
	"segment because HDMI present ran mid-burst. HDMI\n"
