...
static const char kHelpEdit[] =
	...
	"colours follow the theme. Saved as edit_theme in\n"
	".mmbasic.ini (or OPTION EDIT THEME name).\n"
	"Keys: F2 save  F3 open  F9 run  ^O save  Alt+X quit\n"
	"      ^C copy  ^X cut  ^V paste (also ^K/^Y cut line,\n"
	"      ^U paste). Ctrl+X does not quit; use Alt+X.\n"
