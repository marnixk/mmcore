...
static const char kHelpPrint[] =
	...
	"with PRINT #fn. A trailing ; suppresses a newline\n"
	"style gap; , inserts a space between items.\n"
	"\n"
	"Example:  PRINT 6*7\n"
	"          PRINT #1, \"HELLO\"";
...
static const char kHelpMode[] =
	...
	"\n"
	"Set the logical graphics page size and colour depth.\n"
	"n is 1 to 17. bits is 8, 12, 16 or 32 (default 8\n"
	"if omitted). A third argument then clears the page\n"
	"to that colour.\n"
	"\n"
	"MODE updates MM.HRES and MM.VRES and reallocates\n"
	"graphics pages. PIXEL, LINE, BOX, TEXT and PAGE use\n"
	"that logical size. MM.INFO(MODE) is n + bits/100\n"
	"(MODE 8,16 reads as 8.16).\n"
	"\n"
	"MODE does not retune HDMI. On QEMU and typical HDMI\n"
	"the Circle framebuffer stays 640x480. Pixels outside\n"
	"that rectangle stay in the page but are not drawn on\n"
	"the physical screen.\n"
	"\n"
