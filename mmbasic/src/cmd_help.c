...
static const char kHelpMode[] =
	...
	"\n"
	"Set the graphics mode. bits is 8, 12, 16 or 32.\n"
	"An optional third argument clears the screen to that\n"
	"colour. MM.HRES and MM.VRES report the size.\n"
	"\n"
	"Modes (id, width x height):\n"
	"  1 800x600   2 640x400   3 320x200   4 480x432\n"
	"  5 240x216   6 256x240   7 320x240   8 640x480\n"
	"  9 1024x768  10 848x480  11 1280x720 12 960x540\n"
	"  13 400x300  14 960x540  15 1280x1024 16 1920x1080\n"
	"  17 384x240\n"
	"\n"
	"Example:  MODE 8,16";
