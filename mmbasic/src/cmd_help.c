...
static const char kHelpOption[] =
	...
	"  TERM LOG ON|OFF\n"
	"    Capture TERM RX/TX to C:/.termlog (A: if no SD).\n"
	"    Buffered in RAM and flushed every 10 seconds.\n"
	"    Each line: R|T in_total rendered hex. T is a\n"
	"    keystroke; rendered is the last incoming byte\n"
	"    that drew a pane cell. Default OFF.\n"
	"\n"
...
static const char kHelpTerm[] =
	...
	"with incoming (R) and typed (T) hex, flushed every\n"
	"10 seconds. T lines include the last rendered incoming\n"
