...
static const char kHelpTerm[] =
	...
	"with cream text (boxed, MODE 14 960x540). File-menu\n"
	"Boxed/Full: Boxed stays on MODE 14 with an 80-column\n"
	"letterbox. Full restores the MODE that was active\n"
	"when TERM started and uses that width (capped at 120\n"
	"columns) with no letterbox. The choice is for this\n"
	"TERM session only.\n"
