/* IBM VGA 8x16 CP437. Raw BIOS layout: 256 glyphs, 16 bytes each.
 * Source: VGA8.F16 (PC-IBM) from viler-int10h/vga-text-mode-fonts.
 * Used by TERM/TUI so BBS ANSI / CP437 shade and box glyphs match.
 */
#include <stdint.h>

const uint8_t mmb_cp437_8x16[256 * 16] = {
