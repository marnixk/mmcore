...
static const mmb_ed_theme k_themes[ED_THEME_N] = {
	...
	{ "Paper",
	  ...
	  TUI_BLACK, TUI_WHITE,
	  TUI_BRBLACK, TUI_BRBLACK, TUI_CYAN, TUI_BRWHITE, TUI_RED, TUI_BLACK, TUI_CYAN, pal_paper },
	{ "Cloud",
	  ...
	  TUI_BLACK, TUI_WHITE,
	  TUI_BLACK, TUI_BLACK, TUI_CYAN, TUI_BRWHITE, TUI_RED, TUI_BLACK, TUI_CYAN, pal_cloud },
	{ "Snow",
	  ...
	  TUI_BLACK, TUI_WHITE,
	  TUI_BRBLACK, TUI_BRBLACK, TUI_CYAN, TUI_BRWHITE, TUI_RED, TUI_BLACK, TUI_CYAN, pal_snow },
	/* 5 modern dark */
	{ "Night",
	  ...
	  TUI_BRWHITE, TUI_BLACK,
	  TUI_BRBLACK, TUI_BRBLACK, TUI_BLUE, TUI_BRWHITE, TUI_RED, TUI_BRWHITE, TUI_BLUE, pal_night },
	{ "Nord",
	  TUI_BRWHITE, TUI_BRBLACK, TUI_BRCYAN,
	  TUI_BLACK, TUI_CYAN,
	  TUI_BRWHITE, TUI_BLACK,
	  ...
	  TUI_BRWHITE, TUI_BLACK,
	  TUI_BRBLACK, TUI_BRBLACK, TUI_BLUE, TUI_BRWHITE, TUI_RED, TUI_BRWHITE, TUI_BLUE, pal_nord },
	{ "Slate",
	  ...
	  TUI_WHITE, TUI_BLACK,
	  TUI_BRBLACK, TUI_BRBLACK, TUI_BRBLUE, TUI_BRWHITE, TUI_RED, TUI_WHITE, TUI_BRBLUE, pal_slate },
	{ "Forest",
	  ...
	  TUI_BRGREEN, TUI_BLACK,
	  TUI_BRBLACK, TUI_BRBLACK, TUI_BLUE, TUI_BRWHITE, TUI_RED, TUI_BRGREEN, TUI_BLUE, pal_forest },
	{ "Violet",
	  ...
	  TUI_BRWHITE, TUI_BLACK,
	  TUI_BRBLACK, TUI_BRBLACK, TUI_MAGENTA, TUI_BRWHITE, TUI_RED, TUI_BRWHITE, TUI_MAGENTA, pal_violet },
	...
	{ "Turbo",
	  ...
	  TUI_BLACK, TUI_WHITE,
	  TUI_BLACK, TUI_BLACK, TUI_CYAN, TUI_BRWHITE, TUI_RED, TUI_BLACK, TUI_CYAN, 0 },
	{ "Phosphor",
